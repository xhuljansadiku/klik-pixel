...
export const heroVariantAggressive: WebHeroVariant = {
  headline: "Ndërkohë që lexon këtë, konkurrenti yt po i merr klientët tu.",
  subheadline:
    "Ne ndërtojmë sistemin dixhital që punon 24/7 — kthen çdo vizitor në të ardhura reale, dhe i lë konkurrentët tënd pas.",
  description:
    'Çdo muaj pa sistemin e duhur dixhital, humbet para reale — jo "mundësi". Dhjetëra biznese shqiptare nga Tirana te diaspora e kthyen faqen e tyre në burim të vazhdueshëm klientësh. Tani radhë jote.',
  ctaPrimary: "Fillo Tani — Pa Kosto",
  ctaSecondary: "Shiko Si Fitojmë",
