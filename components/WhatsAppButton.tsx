...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      <div
        className={`absolute bottom-14 right-0 w-[260px] rounded-2xl border border-white/12 bg-[#111]/95 p-3 shadow-[0_18px_40px_rgba(0,0,0,0.45)] backdrop-blur-md transition-all duration-300 ${
          open ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-2 opacity-0"
        }`}
      >
        <p className="text-xs text-white/82">Na shkruaj në WhatsApp për një ofertë të shpejtë.</p>
      ...
      <button
        ...
        className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#25D366]/45 bg-[#25D366] text-white shadow-[0_10px_28px_rgba(0,0,0,0.42)] transition-transform duration-300 hover:scale-[1.04] sm:h-12 sm:w-12"
      >
