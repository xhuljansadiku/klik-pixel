  ...
  return (
    <section id="services" ref={sectionRef} className="cinematic-section section-tone-services relative overflow-hidden">
      ...
      <div className="section-wrap">
        ...
        <div className="mt-12 grid auto-rows-[1fr] items-stretch gap-4 md:grid-cols-2 lg:grid-cols-3">
          {serviceItems.map((service, idx) => (
            ...
            >
              ...
              <p className="relative z-[3] mt-3 max-w-[58ch] flex-1 text-sm leading-relaxed text-white/82 transition-opacity duration-[600ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] group-hover:opacity-100">
                {service.desc}
              </p>
              <div className="relative z-[3] mt-4 flex min-h-[6.25rem] flex-wrap content-end gap-2">
              ...
              <p className="relative z-[3] mt-5 min-h-[1.5rem]">
